...
// данный код из https://gist.github.com/Fataho/5b422037a6fdcb21c9134ef34d2fa79a
// Стоит заметить что тут нету конструктора как такогового.
// В оригинале MainWindow создается через JFrame и есть
// фича что Статические методы можно использовать без конструктора как такового.
// Тоесть если что, можно создать класс в котором будут только методы для других классов
/*

import java.awt.image.BufferedImage;

//import java.util.Random;
public class PerlinNoise2D_stolen {

    private static final BufferedImage image = new BufferedImage(MainWindow.WIDTH, MainWindow.HEIGHT, BufferedImage.TYPE_INT_RGB);
    ...
    public static BufferedImage getNoiseImage() {
        ...
        for (int y = 0; y < MainWindow.HEIGHT; y++) {
            for (int x = 0; x < MainWindow.WIDTH; x++) {
                double dx = (double) x / MainWindow.WIDTH; //MainWindow.HEIGHT было это
