package Generate;
//18.11 Надо наконец разобраться с шумом. Глянуть что остальные делают.
//Разобрался с числами, сделал чтобы было не красное а чернобелое
// Надо сделать пикселизацию и разукрасить в нужные цвета. Заодно будет видно какой "пейзаж" выйдет
// И не забыть проанализировать чужие шумы
//
